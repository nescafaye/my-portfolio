...
const Other = () => {
  ...
  return (
    <div className='px-8 md:px-28 py-16 space-y-8 overflow-hidden'>
      ...
      <div className='h-full w-full flex flex-col lg:flex-row gap-x-12'>
          ...
          <div className='w-full xl:w-3/4'>
            ...
            <div className='flex flex-row flex-nowrap gap-8 overflow-x-auto' ref={sliderRef}>
