  ...
  return (
    <section className="h-full flex flex-col lg:flex-row gap-8 px-8 md:px-28 py-16 lg:py-32">
      ...
      <div className="w-full xl:w-1/4 h-fit lg:sticky lg:top-20 xl:top-24">
        <div className="font-secondary text-5xl lg:text-6xl xl:text-7xl font-semibold lg:break-words">
            What I Do
        </div>
      </div>
            ...
            skills.map((skill, index) => {
              return (
                <div className="space-y-8 lg:space-y-10 pb-8 lg:pb-10 border-b border-black dark:border-light" key={index}>
                  <div className="font-primary text-[52px] md:text-6xl lg:text-9xl uppercase leading-none break-words dark:text-transparent neon-stroke text-glow">{skill.skillName}</div>
