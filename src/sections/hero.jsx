...
const Hero = ({intro, isDarkMode }) => {
  ...
  return (
    <section ref={ref} id="home" className="h-full flex flex-col justify-start items-center px-8 md:px-24 py-20 gap-y-12" data-scroll-section>
      <motion.div 
      ...
      <div
        className={`w-full text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[180px] font-regular font-primary tracking-tight uppercase`}>
          <div className="overflow-hidden">
            <motion.div 
              data-scroll data-scroll-speed="-0.5" data-scroll-delay="1" data-scroll-direction="horizontal"
              className="flex gap-2 lg:gap-8 items-center" variants={fadeInUp} initial="from" animate="to" 
          ...
          <div className="overflow-hidden">
            <motion.div
              ...
              className="text-center lg:text-right" variants={fadeInUp} initial="from" animate="to" 
                transition={{type: "spring",
                bounce: 0,
                duration: 1.2,
                ease: "easeIn",
          ...
          <div className="overflow-hidden">
            <motion.div
              data-scroll data-scroll-speed="0.5" data-scroll-direction="horizontal"  
              className="flex gap-2 lg:gap-8 justify-end items-center" variants={fadeInUp} initial="from" animate="to"
                transition={{type: "spring",
                bounce: 0,
                duration: 1.2,
                ease: "easeIn",
